...
export const Header = ({
    ...
    const onPurchase = () => {
        ...
        navigate('/ticket', {
            state: { allProducts, total, folio, date }
        });
    ...
    return (
        <header>
            <h1 className='contacto'>Catálogo disponible</h1>
                ...
                <div className={`container-cart-products ${active ? '' : 'hidden-cart'}`}>
                    {allProducts.length ? (
                        <>
                            ...
                            <button className='btn-clear-all' onClick={onPurchase} style={{ backgroundColor: '#fd8a10' }}>
                                Comprar
                            </button>
